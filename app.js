...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var v=multiply(f,c)[0];
    
    return[e ,v ,a+" and "+b+" and "+c+" sum to "+e+"." ,"The product of "+a+" and "+b+" and "+c+" is "+v+"."]
...
return[s1,a+","+b+","+c+" was passed in as an array of numbers, and "+s1+" is their sum."];
}
...
function multiplyArray([a,b,c]) { //eslint-disable-line
    ...
    return[m1, "The numbers "+a+","+b+","+c+" have a product of "+m1+"."]
    }
